...
function renderTable(locals) {
  ...
  try {
    ...
    (function(products) {
      pug_debug_line = 1;
      pug_debug_filename = 'D:\\Shop-dev\\_views\\_table.pug';
      pug_html =
        pug_html +
      ...
      for (let i = 0; i < products.length; i++) {
        {
          ...
          pug_html =
            pug_html +
            pug_escape(
              null == (pug_interp = products[i].product_name) ? '' : pug_interp
            ) +
            '\u003C\u002Ftd\u003E';
          pug_debug_line = 22;
          pug_debug_filename = 'D:\\Shop-dev\\_views\\_table.pug';
          ...
          pug_html =
            pug_html +
            pug_escape(
              null == (pug_interp = products[i].supplier_name) ? '' : pug_interp
            ) +
            '\u003C\u002Ftd\u003E';
          pug_debug_line = 26;
          pug_debug_filename = 'D:\\Shop-dev\\_views\\_table.pug';
          ...
          pug_html =
            ...
            pug_escape(
              null ==
                (pug_interp = `${products[i].quantity} ${products[i].unit}`)
                ? ''
                : pug_interp
            ) +
            '\u003C\u002Ftd\u003E';
          ...
          pug_html =
            pug_html +
            pug_escape(
              null == (pug_interp = products[i].cost) ? '' : pug_interp
            ) +
            '\u003C\u002Ftd\u003E';
          pug_debug_line = 29;
          pug_debug_filename = 'D:\\Shop-dev\\_views\\_table.pug';
          ...
          pug_html =
            pug_html +
            pug_escape(
              null == (pug_interp = products[i].place) ? '' : pug_interp
            ) +
            '\u003C\u002Ftd\u003E';
          pug_debug_line = 30;
          pug_debug_filename = 'D:\\Shop-dev\\_views\\_table.pug';
          ...
          pug_html =
            pug_html +
            pug_escape(
              null == (pug_interp = products[i].date.toString().slice(0, 10))
                ? ''
                : pug_interp
            ) +
            '\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E';
